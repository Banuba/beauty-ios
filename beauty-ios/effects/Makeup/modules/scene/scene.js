...
if (!target) {
    const CameraBackground = new mesh.Mesh(new geometry.PlaneGeometry(), new material.BlitMaterial(new texture.Camera(), { blending: "OFF" }));
...
class Scene {
    constructor() {
        Object.defineProperty(this, "_target", {
            ...
            configurable: true,
            writable: true,
            value: new renderTarget.RenderTarget()
        });
        this._target = screen;
        const scene = new mesh.Mesh(new geometry.PlaneGeometry(), new material.BlitMaterial(this._target.texture, { blending: "OFF" }));
